    ...
    try:
        for page in root.findall('page'):
            with open('objects/' + file + '.csv', 'r') as log:
                ...
                title = (
                        '[Maryland] ' + surname + ', ' + givenname + ' - Age ' + age + ', Year: ' + year + ' - ' + military_unit).encode(
                    'utf-8')
...
<accessFilename>https://s3.amazonaws.com/NARAprodstorage/""" + file_path + """</accessFilename><accessFileSize>""" + str(
                    file_size) + """</accessFileSize>
