# This script combined the newly-generated XML files from reformat_partner_xml.py into files of 75 KB or less for import into the Description and Authority Service (DAS).
